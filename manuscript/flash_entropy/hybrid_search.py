    ...
    def search(self, *, precursor_mz, peaks, ms2_tolerance_in_da, target="cpu", check_peaks=True, **kwargs):
        ...
        if target == "cpu":
            ...
            for peak_idx, (mz, intensity) in enumerate(peaks):
                ...
                entropy_similarity.scatter_add(cp.array(modified_idx_product), modified_value_product)
                ...
                entropy_similarity.scatter_add(cp.array(modified_idx_nl), modified_value_nl)
